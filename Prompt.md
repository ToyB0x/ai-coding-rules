...
#### 📖 参照すべき.clinerules内のファイル

Clineは以下の.clinerules内のファイルを優先的に参照すべきです：

- `.clinerules/README.md` - ディレクトリの概要と含まれるファイルの説明
- `.clinerules/commit-rules.md` - コミット提案とメッセージ作成の詳細ルール
- `.clinerules/prompt-changelog-guide.md` - Changelog記載のガイドライン

#### 📑 Clineのための参考資料

- `.clinerules/README.md`: .clinerules配下の全体を俯瞰できるIndex
- `.clinerules/important-docs.md`: プロジェクトの重要な資料の場所をまとめたもの

#### 💾 コミットの提案とメッセージ記録

> **コミットルールの重要性**: コミットメッセージの作成と提案に関する詳細なルールは `.clinerules/commit-rules.md` に記載されています。
...
LLMは以下の指示資料を参照してください:

- `.clinerules/prompts/update-docs.md`: ドキュメント更新のルールと手順
- `README.md` (リポジトリトップ): 人間向けの便利な指示例
...
> **Repomixの優先的活用**: `.clinerules/repomix.md` には以下の重要な指針が記載されています:

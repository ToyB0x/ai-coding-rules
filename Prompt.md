...
## 概要
このドキュメントはLLMを活用した開発のベストプラクティスを以下のガイドラインにまとめたものです。
- **CLINE等のAIが従うべきガイドライン**: コミット提案、コード理解など、AI支援開発における様々なガイドラインを整備
- **ドキュメント管理のガイドライン**: プロジェクトにおける人とLLMが理解しやすいドキュメント管理のベストプラクティスを提供

# 利用方法

- 「作成・更新すべき資料」を参照し、プロジェクトに必要な、ガイドラインを具体化したドキュメントを作成・更新してください。LLMはこのドキュメントを作成してください。
- 作成された、ガイドラインを具体化したドキュメント自体が自動的にLLMから参照されるような構造になっています。
...
## 2025/03/22
- [更新] 「ドキュメント作成・更新のルール」と「進捗管理とセルフモニタリング」のセクションを「作成・更新すべき資料」の配下に移動
- [更新] ドキュメント全体のリファクタリングを実施し、冗長な表現を簡潔化
- [更新] 「概要と利用方法」と「ドキュメント作成・更新のルール」の重複する説明を統合
- [更新] 全体的に箇条書きを活用して簡潔に表現
